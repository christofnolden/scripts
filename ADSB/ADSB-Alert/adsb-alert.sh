...
SEARCH_PATTERNS=("CHX" "LIFELN" "RESQ" "GAMMED" "JOKER" "SAREX" "GAM" "AIRESC" "HUMMEL" "NATO" "ESSO" "SONIC" "MRPHY" "LIMIT" "STLON" "BLOOD" "GRIFN" "DUKE" "SPADE") # The Callsign searchpatterns with wildcard
